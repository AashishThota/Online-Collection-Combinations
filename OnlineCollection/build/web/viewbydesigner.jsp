...
%>
  ...
  <label for="star5">star5</label>
 <br/> <input type="radio" name="rating" id="star4" value="4">
  <label for="star4">star4</label>
 <br/> <input type="radio" name="rating" id="star3" value="3">
  <label for="star3">star3</label>
<br/>  <input type="radio" name="rating" id="star2" value="2">
  <label for="star2">star2</label>
<br/>  <input type="radio" name="rating" id="star1" value="1">
  <label for="star1">star1</label>
</div>
