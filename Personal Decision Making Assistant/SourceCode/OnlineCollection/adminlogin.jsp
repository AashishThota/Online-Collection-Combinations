	...
	<div id="body">
		<div id="featured">
			...
			<div class="last">
				...
				<table>
				<tr>
				<td><h4>Admin Name:</h4></td><td><input type="text" id="newsletter"  name="aname" required/></td>
				</tr>
				<tr>
				<td><h4>PassWord:</h4></td><td><input type="password"   id="newsletter"  name="apass" required/></td>
				</tr>
				<tr>
